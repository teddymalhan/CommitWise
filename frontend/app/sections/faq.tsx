...
export default function Faq() {
  return (
    <div>
      <section className="bg-zinc-500 py-20 font-base lg:py-[100px]">
        ...
        <div className="mx-auto grid w-[700px] max-w-full px-5">
          <Accordion className="text-base sm:text-lg" type="single" collapsible>
            <AccordionItem className="mb-2" value="item-1">
              <AccordionTrigger>What is CommitWise?</AccordionTrigger>
              <AccordionContent>
                CommitWise is a developer tool that tracks and stores commits, provides AI-powered explanations for each change, and offers detailed code diff views to enhance collaboration and understanding within teams.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem className="mb-2" value="item-2">
              <AccordionTrigger>How does CommitWise integrate with my GitHub repository?</AccordionTrigger>
              <AccordionContent>
                CommitWise seamlessly integrates with your GitHub repository. Once connected, it pulls in your commit history, stores files securely, and provides AI-powered insights into every change.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem className="mb-2" value="item-3">
              <AccordionTrigger>Can CommitWise help with code reviews?</AccordionTrigger>
              <AccordionContent>
                Absolutely! CommitWise enhances code reviews by providing easy-to-read diffs and AI-generated explanations for each commit, helping team members understand the context behind the changes more easily.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-4">
              <AccordionTrigger>How secure is my data?</AccordionTrigger>
              <AccordionContent>
                Your data is securely stored using AWS services like DynamoDB and S3, with built-in encryption and access control. We ensure all your code and commits are safe and accessible only by your authorized users.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
