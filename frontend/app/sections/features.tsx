  ...
  const features = [
    {
      ...
      text: 'Easily track and monitor every commit with detailed explanations and version control.',
    },
    {
      title: 'Real-Time Collaboration',
      text: 'Collaborate with team members in real-time and view changes as they happen in the repository.',
    },
    {
      title: 'AI-Powered Explanations',
      text: 'Generate in-depth explanations for each code commit using AI, helping team members understand the code better.',
    },
    {
      title: 'Commit History Visualization',
      text: 'Visualize commit history with an interactive timeline, making it easier to see the evolution of the project.',
    },
    {
      title: 'Secure Repository Integration',
      text: 'Securely connect your repositories with CommitWise, supporting GitHub and other Git platforms.',
    },
    {
      title: 'Detailed Change Diffs',
      text: 'View side-by-side comparisons of changes between commits with detailed diff and context.',
    },
  ];

  return (
    <div>
      <section className="border-t-border border-t-2 py-20 font-base lg:py-[100px] pattern-cross pattern-blue-500 pattern-bg-white
  pattern-size-6 pattern-opacity-20 bg-gray">
        ...
        <div className="mx-auto grid w-container max-w-full grid-cols-1 gap-5 px-5 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, i) => {
            ...
            return (
              <div
                className="border-border shadow-light flex flex-col gap-3 rounded-base border-2 bg-white p-5"
                key={i}
              >
                <Icon />

                <h4 className="mt-2 text-xl font-heading text-black">
                  {feature.title}
                </h4>
      ...
      <div>
        <Marquee
          className="border-y-border border-y-2 bg-white py-3 font-base sm:py-5"
          direction="left"
        >
          {Array(10)
            .fill('xd')
            .map((x, id) => {
              return (
                <div className="flex items-center" key={id}>
                  <span className="mx-10 text-xl font-heading sm:text-2xl lg:text-4xl text-black">
                    CommitWise: Revolutionizing the way you code
                  </span>
                  <Star3 />
                </div>
              )
